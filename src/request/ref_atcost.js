...
exports.getNomorSpm = [
    ...
    check("datapengajuanatcost").notEmpty().withMessage("datapengajuanatcost harus di ada."),
    check("datapengajuanatcost").isArray().withMessage("datapengajuanatcost adalah Array"),
  ];